...
public class ResourcesForTest {
    ...
    public static final Pokemon florizarre =
            new Pokemon(UUID.randomUUID().toString(), "Florizarre", "Graine",
                    ...
                    633, 82, 83, 80, 100, 100,
                    "Fleur", "Poison", "Mixte",
                    "Monstrueux", "Végétal",
                    "Engrais2", "Chlorophyle2",

                    "", "", "", "");


    public static final Flux<Pokemon> fluxPokemons = Flux.just(bulbizarre, herbizarre, florizarre);
}
